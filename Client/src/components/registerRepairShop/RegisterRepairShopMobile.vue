...
<template>
    <div class="mobile-form-background">
        ...
        <form @submit.prevent="handleRegistration" class="mobile-register-form">
            ...
            <input type="email" name="email" placeholder="namn@mail.com" @blur="checkInputData" v-model="confirmEmail" :class="isEmailWrong ? 'input-error' : ''">
            <p v-if="isEmailWrong"><fontAwesome :icon="['fas', 'triangle-exclamation']" />Vänligen kontrollera email adressen!</p>
            
            <label for="password">Lösenord</label>
            <input type="password" name="password" placeholder="Lösenord" @input="checkPasswordStrength('password')" v-model="password" :class="{ 'input-error': isPasswordWrong, 'input-password-weak': isPasswordWeak }">
